...
public class CirkelsessieApiTest extends ApiTest
{
    ...
    public void updateCirkelsessie() throws Exception
    {
        ...
        cirkelsessie = new CirkelsessieRequest("Session two", Status.OPEN, 8, 15, DateTime.now(), 1, 1);
        json = objectMapper.writeValueAsString(cirkelsessie);
    ...
    public void showActieveCirkelSessies() throws Exception
    {
        ...
        CirkelsessieRequest cirkelsessie = new CirkelsessieRequest("Session one", Status.GESLOTEN, 10, 10, DateTime.now().plusDays(1), 1, 1);
        json = objectMapper.writeValueAsString(cirkelsessie);
        ...
        cirkelsessie = new CirkelsessieRequest("Session three", Status.OPEN, 10, 10, DateTime.now().minusDays(1), 1, 1);
        json = objectMapper.writeValueAsString(cirkelsessie);
